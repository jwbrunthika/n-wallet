...
## Monorepo Structure
- `docker-compose.yml`
- `.env.docker.example` (copy to untracked `.env.docker` for local/VPS runtime secrets)
...
### SMTP placeholders in `.env.docker.example`
- Host: `smtp.example.com`
- Port: `587`
- Username: `change-me`
- Password: configured only in untracked `.env.docker`
- Encryption: `tls`
